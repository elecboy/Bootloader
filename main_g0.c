...
board_init(void)
{
	...
	gpio_set_output_options(BOARD_PORT_LEDS, GPIO_OTYPE_OD,
				GPIO_OSPEED_2MHZ, BOARD_PIN_LED_BOOTLOADER | BOARD_PIN_LED_ACTIVITY);
	gpio_mode_setup(BOARD_PORT_LEDS, GPIO_MODE_OUTPUT,
				GPIO_PUPD_PULLUP, BOARD_PIN_LED_BOOTLOADER | BOARD_PIN_LED_ACTIVITY);
